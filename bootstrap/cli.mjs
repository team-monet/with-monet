 ...
 */
const line = "Set up Monet for this project: read https://raw.githubusercontent.com/team-monet/with-monet/main/bootstrap/install.md and follow it, checking with me at each decision point.";
...
console.log(`  ${line}\n`);
console.log("The agent then follows bootstrap/install.md: orient → get Monet Local → configure");
